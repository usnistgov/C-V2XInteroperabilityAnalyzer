...
2. Ensure Python 3.12 and [PDM](https://pdm-project.org/) are installed.
   For example, using [pipx](https://pipx.pypa.io/stable/):
...
5. Output is printed to stdout, but can be redirected or piped to a text file using the shell.
...
## How to Use on Windows with Git Bash

Download and install the Git software on your Windows machine. This C-V2X interoperability analyzer software tool is Python-based, developed with Python3. Python should be added to path upon installation.
